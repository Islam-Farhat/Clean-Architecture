...
{
    public class GetOrdersDriverQuery : IRequest<List<GetOrdersDto>>
    {
        ...
        private class GetOrdersDriverQueryHandler : IRequestHandler<GetOrdersDriverQuery, List<GetOrdersDto>>
        {
            ...
            public GetOrdersDriverQueryHandler(
            ...
            public async Task<List<GetOrdersDto>> Handle(GetOrdersDriverQuery request, CancellationToken cancellationToken)
            {
